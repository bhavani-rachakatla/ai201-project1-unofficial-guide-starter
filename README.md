...
|---|----------|-----------------|------------------------------|-------------------|-------------------|
| 1 | Which professor has reasonable or clearly explained exams? | The system should cite reviews mentioning reasonable exams, clear exam expectations, cheat sheets, or exam preparation. | The system identified Kirill Morozov and Jiang Beilei as having reasonable or clearly explained exams. It also mentioned Jesus Quevedo-Torrero because one retrieved review said his exams were open-note, though some students found them harder. | Relevant | Accurate |
| 2 | Which professor is described as caring or helpful? | The system should cite reviews or tags mentioning caring, helpfulness, accessibility, or clear explanations. | The system identified Tanmay Bera, Kirill Morozov, and Haili Wang as caring, and also mentioned Russel Pears as kind and genuine. | Relevant | Accurate |
| 3 | Which professor seems to have a manageable workload? | The system should cite reviews mentioning manageable homework, enough time for assignments, easy workload, or reasonable class expectations. | The system identified Stephanie Ludi and Haili Wang as having manageable workloads. It cited Ludi’s lower difficulty rating and a review saying the class is manageable if students put in the work, and it cited Wang’s low difficulty rating. | Partially relevant | Partially accurate |
| 4 | What do students say about attendance expectations? | The system should cite reviews that explicitly mention attendance as mandatory, not mandatory, optional, or important. | The system summarized that attendance varies by professor: Jiang Beilei, Kirill Morozov, and Ryan Garlick were listed as not mandatory, while Stephanie Ludi was listed as mandatory with some meeting-week context. | Relevant | Accurate |
| 5 | Which professor is best for machine learning research? | The system should say it does not have enough information unless the documents specifically mention machine learning research. | The system responded: “I don't have enough information in the provided documents to answer that.” | Relevant if it refuses / Off-target if it retrieves general professor reviews | Accurate if it refuses / Inaccurate if it invents an answer |
